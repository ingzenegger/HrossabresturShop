...
- [ ] for ProductCard, could have addtocart button as popover, in popover a select for variants, that way user can skip the detail page and get directly to cart.
